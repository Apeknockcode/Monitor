import { EVENTTYPES, BREADCRUMBTYPES } from '@brolisten/common';
import { validateOption, getTimestamp, _support } from '@brolisten/utils';
import { BreadcrumbData, InitOptions } from '@brolisten/types';
